...
| Artifacts | Structured storage and sharing of generated HTML, markdown, and code snippets. | [Foundations group](/claude-code/foundations) |
...
- **Artifacts**: Stores HTML, markdown, and code snippets generated by Claude, providing structured organization and easy sharing.
