...
{{< callout type="info" >}}
  **A SPEC consists of 3 files:** running `/moai plan` generates `spec.md` (GEARS requirements), `plan.md` (implementation plan), and `acceptance.md` (acceptance criteria) at the same time.
{{< /callout >}}
...
| File | Role | Content |
| --- | --- | --- |
| `spec.md` | GEARS requirements definition | YAML frontmatter, requirements (5 GEARS types), constraints, dependencies |
