...
{{< callout type="info" >}}
For the SPEC 3-Phase lifecycle commands (`/moai plan`, `run`, `sync`, `project`, `design`, `harness`), see the [workflow commands](/en/workflow-commands/) section. The full list of 16 subcommands the `/moai` orchestrator routes is also there.
{{< /callout >}}
