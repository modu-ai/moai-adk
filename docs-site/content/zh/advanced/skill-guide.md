...
MoAI-ADK 共有 **32 个技能** — moai 伞形路由器加上 31 个专业技能,分为 6 大类: Foundation(4)、Workflow(10)、Domain(9)、Reference(5)、Meta/Harness(2)、Design(1)。编程语言支持通过 `rules/moai/languages/` 下的规则提供,而不是单独的技能。
...
| 技能名称              | 描述                                             |
| ---------------------- | ------------------------------------------------ |
| `moai-design-system`  | 意图优先设计, WCAG 2.1 可访问性, 设计令牌      |
...
- **原有方式**: 32 个技能全部加载 = 约 160,000 tokens (不可行)
