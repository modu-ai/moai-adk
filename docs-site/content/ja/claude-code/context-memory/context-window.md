...
| サイズ (一般論) | 意味 |
|---------------|------|
| 約 200K トークン | Haiku、およびゲートウェイ・旧モデルの Sonnet/Opus の標準ウィンドウ。一般的なコード作業に十分 |
| 約 1M トークン | Anthropic API の Sonnet 5・Opus のネイティブウィンドウ（および一部の他モデル）。大規模コードベース (large codebase) に有利 |
