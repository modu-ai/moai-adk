...
MoAI-ADK は基本提供される 31 スキル、8 エージェント以外に、ユーザーが直接拡張できる 3 つのビルダーエージェントを提供します。
...
- ML モデル開発 (manager-develop に委任)
- インフラ構成 (manager-develop に委任)

## Delegation Protocol

- ML モデル必要時: manager-develop
- インフラ設定時: manager-develop
