...
- **100K+ 行**の Go コード、**100+** パッケージ
- **85-100%** テストカバレッジ
- **8** の専門 AI エージェント + **27** のスキル
- **16** のプログラミング言語サポート
- **27** の Claude Code フックイベント
...
- **8 の専門エージェント**: 各開発フェーズに特化した AI エージェントチーム (7 MoAI カスタム + Anthropic 組み込み Explore)
- **27 のスキル**: さまざまな開発シナリオをサポートする拡張可能なスキルライブラリ
- **多言語サポート**: 韓国語、英語、日本語、中国語の 4 言語をサポート
- **Adaptive Thinking**: `ultrathink` キーワード経由で Opus 4.7+/4.8 と Sonnet 4.6 の組み込み推論モードで複雑な問題を分析
- **Ralph-Style LSP Integration**: LSP ベースの自律ワークフローとリアルタイム品質フィードバック

## 主な機能

MoAI-ADK は 8 の専門 AI エージェントと 27 のスキルを提供し、開発ワークフロー全体を自動化・最適化します。
...
|----------|--------|---------|-----------|----------|------|
| **High** | Max $200/月 | 16 | 5 | 3 | 最高品質、最大スループット |
| **Medium** | Max $100/月 | 3 | 17 | 4 | 品質とコストのバランス |
| **Low** | Plus $20/月 | 0 | 13 | 11 | 経済的、Opus アクセスなし |
...
- **LSP ベース完了自動検出**: コード品質状態をリアルタイムでモニタリング
