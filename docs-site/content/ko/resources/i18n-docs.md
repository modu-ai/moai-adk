...
문서의 원본(정규 로케일)은 **한국어(ko)** 입니다. 세 파생 로케일(en·ja·zh) 모두 한국어 원천에서 직접 번역됩니다.
...
- **en·ja·zh** 세 로케일 모두 **ko 에서 직접** 파생됩니다 — en 을 거치지 않습니다.
...
한국어가 원천 언어이고 en·ja·zh 가 파생되므로, 번역이 한국어의 문장 구조를 그대로 옮기는 "번역투"(calque) 에 빠지기 쉽습니다. 각 언어의 자연스러운 표현을 씁니다.

- 한국어에서 "세 축" / "일곱 기둥" 같은 구조적 비유는 피합니다. "세 가지 핵심" / "일곱 가지 강점" 이 자연스럽습니다.
- 한국어 원문의 비유적 표현을 낱말 단위로 옮기지 말고, 각 언어에서 같은 뜻을 전하는 자연스러운 표현을 찾습니다.
