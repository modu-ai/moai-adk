...
MoAI-ADK의 버전별 변경 사항을 정리한 페이지입니다. 각 항목은 릴리스할 때
저장소의 `CHANGELOG.md`와 함께 갱신하며, 추가된 기능·변경된 동작·수정된 결함을
같은 순서로 담습니다.
...
최근 5개 버전을 이 자리에 싣습니다. 아직 올라온 항목은 없으며, 다음 릴리스부터
채워 나갑니다.

## 이전 버전

여기에 싣지 않은 과거 버전의 전체 기록은 저장소의
