...
3. **예산을 시스템이 지킨다** — 토큰 사용을 추적하고, 임계 초과 전에 우아하게 멈춘다.
...
`moai cg`는 Claude 리더와 GLM 워커를 결합한 하이브리드 모드입니다. 전략, 계획, 감사는 Claude가 담당하고, 대량 구현 작업은 GLM이 담정합니다. 구현 중심 작업에서 60-70% 비용 절감 효과가 있습니다.
