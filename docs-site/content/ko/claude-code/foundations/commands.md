...
슬래시 명령은 세 가지 종류로 구성됩니다. 자주 쓰는 명령을 정리하면 다음과 같습니다. 전체 목록은 입력창에서 `/`를 입력하면 확인되고, 공식 명령 레퍼런스는 [code.claude.com/docs/en/commands](https://code.claude.com/docs/en/commands) 를 참고합니다.
