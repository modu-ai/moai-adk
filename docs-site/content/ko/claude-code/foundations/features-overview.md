...
MoAI-ADK는 바로 이 Claude Code 위에서 동작하는 에이전틱 개발 키트입니다. 여기 나열된 기능은 MoAI-ADK 세 기둥의 원재료이기도 합니다. 컨텍스트 윈도우와 캐싱은 **토크노믹스**의, 서브에이전트·팀·워크트리는 **에이전틱 루프 엔지니어링**의, 스킬·훅·MCP·플러그인은 **에이전틱 하네스**의 재료입니다. 여기서 개념을 잡아 두면 MoAI-ADK가 이것들을 어떻게 오케스트레이션하는지 훨씬 빠르게 이해할 수 있습니다.
