...
//
//	-X github.com/modu-ai/moai-adk/go/pkg/version.Version={{.Version}}
//	-X github.com/modu-ai/moai-adk/go/pkg/version.Commit={{.Commit}}
//	-X github.com/modu-ai/moai-adk/go/pkg/version.Date={{.Date}}
package version
