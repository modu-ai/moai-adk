...
Create SKILL.md and supporting files in `.pi/generated/source/skills/<prefix>-<name>/` directory (prefix is `my-` by default, or `moai-` with `--moai` flag). Apply frontmatter, write content sections, and verify line count.
...
2. Personal: `~/.pi/generated/source/skills/` (individual)
3. Project: `.pi/generated/source/skills/` (team-shared, version-controlled)
...
- Default: `my-<name>` → directory `.pi/generated/source/skills/my-<name>/`
- With `--moai` flag: `moai-<name>` → directory `.pi/generated/source/skills/moai-<name>/`
...
[HARD] Skills MUST be created in `.pi/generated/source/skills/` directory, NEVER in `.moai/skills/`.
...
```
.pi/generated/source/skills/{skill-name}/SKILL.md
```

Examples:
- `.pi/generated/source/skills/moai-library-pykrx/SKILL.md`  ✅ correct
- `.pi/generated/source/skills/my-analyzing-code/SKILL.md` ✅ correct
- `.pi/generated/source/skills/moai/library/pykrx.md`          ❌ WRONG: nested dirs + wrong filename
- `.pi/generated/source/skills/moai-library/pykrx.md`           ❌ WRONG: wrong filename
