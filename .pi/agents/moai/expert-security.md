...
1. **AST-Grep Security Scan**: Use `sg scan --config .pi/generated/source/skills/moai-tool-ast-grep/rules/sgconfig.yml` to detect structural vulnerability patterns
