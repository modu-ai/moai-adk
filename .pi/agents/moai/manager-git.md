...
- Commit messages: Read git_commit_messages from .pi/generated/source/moai-config/sections/language.yaml
...
@.pi/generated/source/moai-config/sections/git-strategy.yaml
...
- Read git_commit_messages from .pi/generated/source/moai-config/sections/language.yaml
...
- Access: `.pi/generated/source/moai-config/sections/language.yaml`
...
- Read development_mode from `.pi/generated/source/moai-config/sections/quality.yaml`
...
- Read active mode from `git_strategy.mode` in `.pi/generated/source/moai-config/sections/git-strategy.yaml`
...
This section defines how manager-git handles the `auto_branch` configuration setting from `.pi/generated/source/moai-config/sections/git-strategy.yaml`.

### Configuration Reading

Before any branch operation, read the auto_branch setting:

1. Locate configuration file: `.pi/generated/source/moai-config/sections/git-strategy.yaml`
