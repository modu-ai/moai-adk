...
Source hash: 3498c8695997eb97
Generated: 2026-05-09T06:56:22.163Z
...
- Maintain file creation scope to `.moai/project/` directory only, excluding `.pi/state/memory/` and `.pi/generated/source/commands/moai/*.json` paths
...
- Leverage .pi/generated/source/CLAUDE.md's existing `@.moai/project/*` import mechanism and append language metadata for context retention
