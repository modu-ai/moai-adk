...
User personalization and language settings follow the centralized system in .pi/generated/source/CLAUDE.md (User Personalization and Language Settings section). MoAI automatically loads settings at session start to provide consistent responses.
...
- [HARD] All responses must be in the language specified by conversation_language in .pi/generated/source/moai-config/sections/language.yaml
...
- Configuration file: .pi/generated/source/moai-config/sections/language.yaml
...
Refer to .pi/generated/source/CLAUDE.md for complete AskUserQuestion guidelines including detailed usage instructions, format requirements, and language enforcement rules.
...
Version: 2.1.0 (.pi/generated/source/CLAUDE.md v9.0.0 Compliance)
