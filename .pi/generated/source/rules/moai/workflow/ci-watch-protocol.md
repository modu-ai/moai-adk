...
paths:
  - ".pi/generated/source/skills/moai-workflow-ci-watch/SKILL.md"
...
The `(권장)` label MUST be on the first option per `.pi/generated/source/rules/moai/core/askuser-protocol.md`.
