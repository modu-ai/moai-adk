...
- 파일 순서 고정: `.pi/generated/source/CLAUDE.md` → `.pi/generated/source/rules/moai/core/moai-constitution.md` → `.pi/generated/source/rules/moai/core/agent-common-protocol.md` → `.pi/generated/source/rules/moai/design/constitution.md`
...
# 특정 파일의 조항만 조회
moai constitution list --file .pi/generated/source/rules/moai/core/moai-constitution.md
...
```yaml
# ============================================================
# 001-010: .pi/generated/source/CLAUDE.md HARD 조항 (§1 Hard Rules)
# ============================================================
- id: CONST-V3R2-001
  zone: Frozen
  file: .pi/generated/source/rules/moai/workflow/spec-workflow.md
...
- id: CONST-V3R2-002
  zone: Frozen
  file: .pi/generated/source/rules/moai/core/moai-constitution.md
...
- id: CONST-V3R2-003
  zone: Frozen
  file: .pi/generated/source/rules/moai/workflow/mx-tag-protocol.md
  anchor: "#mx-tag-types"
...
- id: CONST-V3R2-004
  zone: Frozen
  file: .pi/generated/source/rules/moai/development/coding-standards.md
...
- id: CONST-V3R2-006
  zone: Frozen
  file: .pi/generated/source/rules/moai/core/agent-common-protocol.md
...
- id: CONST-V3R2-007
  zone: Frozen
  file: .pi/generated/source/CLAUDE.md
  anchor: "#1-core-identity"
  clause: "Claude Code substrate"
  canary_gate: true

# ============================================================
# 008-020: .pi/generated/source/CLAUDE.md HARD 조항 (§1 Hard Rules — 오케스트레이터 동작)
# ============================================================
- id: CONST-V3R2-008
  zone: Evolvable
  file: .pi/generated/source/CLAUDE.md
...
# ============================================================
# 020-030: .pi/generated/source/CLAUDE.md §14 Worktree Isolation Rules + §11 Background Agent
# ============================================================
- id: CONST-V3R2-020
  zone: Evolvable
  file: .pi/generated/source/CLAUDE.md
...
- id: CONST-V3R2-051
  zone: Frozen
  file: .pi/generated/source/rules/moai/design/constitution.md
  anchor: "#2-frozen-vs-evolvable-zones"
  clause: "[FROZEN] This constitution file (.pi/generated/source/rules/moai/design/constitution.md)"
  canary_gate: true
...
- id: CONST-V3R2-150
  zone: Evolvable
  file: .pi/generated/source/rules/moai/workflow/session-handoff.md
