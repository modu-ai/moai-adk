...
- **Git strategy**: Reads `github.git_workflow` from `.pi/generated/source/moai-config/sections/system.yaml`
...
Read user's `conversation_language` from `.pi/generated/source/moai-config/sections/language.yaml`.
