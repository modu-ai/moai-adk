...
2. **Handle uncommitted files**:
   - If untracked files in `.pi/generated/source/` exist: Check if they should be committed or discarded
   - Clean up command:
   ```bash
   git checkout -- .pi/generated/source/
   git clean -fd .pi/generated/source/ internal/template/templates/.pi/generated/source/
   ```
...
2. Edit `.pi/generated/source/moai-config/sections/system.yaml` `moai.version` AND `moai.template_version`
3. Edit `internal/template/templates/.pi/generated/source/moai-config/sections/system.yaml` `moai.version`
4. Commit: `git add pkg/version/version.go .pi/generated/source/moai-config/sections/system.yaml internal/template/templates/.pi/generated/source/moai-config/sections/system.yaml && git commit -m "chore: bump version to vX.Y.Z"`

Version files checklist:
- [ ] pkg/version/version.go: Version = "vX.Y.Z"
- [ ] .pi/generated/source/moai-config/sections/system.yaml: moai.version: "X.Y.Z"
- [ ] .pi/generated/source/moai-config/sections/system.yaml: moai.template_version: "vX.Y.Z"
- [ ] internal/template/templates/.pi/generated/source/moai-config/sections/system.yaml: moai.version: "X.Y.Z"
...
- Template/rules file optimization (`.pi/generated/source/rules/`, `.pi/generated/source/skills/`, `.pi/agents/overrides/`)
...
If local `.pi/generated/source/` or `.moai/` files are out of sync with the templates:
...
```bash
$ git status
modified:   internal/cli/.pi/generated/source/agents/moai/manager-spec.md
modified:   internal/cli/.pi/generated/source/commands/moai/01-plan.md
# ... many more files in internal/cli/.pi/generated/source/
```
...
git checkout -- internal/cli/ .pi/generated/source/
git clean -fd .pi/generated/source/ internal/template/templates/.pi/generated/source/
...
- `.pi/generated/source/moai-config/sections/system.yaml` shows 2.0.5
- `internal/template/templates/.pi/generated/source/moai-config/sections/system.yaml` shows 2.0.5
...
grep -n "moai.version\|template_version" .pi/generated/source/moai-config/sections/system.yaml
grep -n "moai.version" internal/template/templates/.pi/generated/source/moai-config/sections/system.yaml
