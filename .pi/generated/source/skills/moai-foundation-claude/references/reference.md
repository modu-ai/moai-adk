...
Command Location:
- Personal: `~/.pi/generated/source/commands/`
- Project: `.pi/generated/source/commands/`
...
2. User settings (`~/.pi/generated/source/settings/claude-settings.json`)
3. Project settings (`.pi/generated/source/settings/claude-settings.json`)
4. Local settings (`.pi/overrides/settings.local.json`)
...
- User: `~/.pi/claude-compat/.pi/generated/source/CLAUDE.md`
- Project: `./.pi/generated/source/CLAUDE.md` or `.pi/generated/source/.pi/generated/source/CLAUDE.md`
