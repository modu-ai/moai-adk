...
**Output**:
```markdown
# File: .pi/generated/source/commands/deploy.md
---
...
```json
// File: .pi/generated/source/settings/claude-settings.json (hooks section)
{
  "hooks": {
    "PreToolUse": [
      {
...
```markdown
# File: .pi/generated/source/.pi/generated/source/CLAUDE.md (Project-level memory)
...
```markdown
# File: .pi/generated/source/architecture.md
...
```json
// ~/.pi/generated/source/settings/claude-settings.json (User-level)
{
  "preferences": {
    "outputStyle": "concise",
    "codeStyle": "modern"
...
```json
// .pi/generated/source/settings/claude-settings.json (Project-level)
{
