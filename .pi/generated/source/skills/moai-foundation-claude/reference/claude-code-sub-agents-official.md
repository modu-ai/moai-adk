...
Project Sub-agents: .pi/agents/overrides/agent-name.md
Personal Sub-agents: ~/.pi/agents/overrides/agent-name.md
...
1. Project Level: .pi/agents/overrides/ (highest priority)
2. User Level: ~/.pi/agents/overrides/ (lower priority)
