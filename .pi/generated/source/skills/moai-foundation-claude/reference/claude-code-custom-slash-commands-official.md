...
1. Personal Commands: `~/.pi/generated/source/commands/` (highest priority)
2. Project Commands: `.pi/generated/source/commands/` (team-shared)
3. Plugin Commands: Bundled with installed packages (lowest priority)

Directory Structure:

```
.pi/generated/source/commands/
 category1/
 my-command.md
 related-command.md
 category2/
...
- `.pi/generated/source/commands/{namespace}/{command-name}.md` → `/{namespace}:{command-name}`
- `.pi/generated/source/commands/my-command.md` → `/my-command`
- Example: `.pi/generated/source/commands/moai/fix.md` → `/moai:fix`
...
git add .pi/generated/source/commands/
...
```markdown
# .pi/generated/source/commands/README.md
