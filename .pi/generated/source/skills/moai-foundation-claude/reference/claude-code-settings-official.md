...
2. User Settings: `~/.pi/generated/source/settings/claude-settings.json` (personal preferences)
3. Project Settings: `.pi/generated/source/settings/claude-settings.json` (team-shared)
4. Local Settings: `.pi/overrides/settings.local.json` (local overrides)
...
```json
{
 "plugins": {
 "enabled": true,
 "pluginPaths": ["./plugins", "~/.pi/claude-compat/plugins"],
 "loadedPlugins": [
 "git-integration",
 "docker-helper",
 "database-tools"
...
~/.pi/generated/source/settings/claude-settings.json

# Project settings (team-shared)
./.pi/generated/source/settings/claude-settings.json

# Local overrides (development)
./.pi/overrides/settings.local.json

# Environment-specific overrides
./.pi/generated/source/settings.${ENVIRONMENT}.json
```
...
```json
{
 "logging": {
 "level": "info",
 "file": "~/.pi/claude-compat/logs/claude.log",
 "maxFileSize": "10MB",
 "maxFiles": 5,
 "format": "json",
 "include": [
