...
- Configuration added to .pi/generated/source/settings/claude-settings.json
...
Team admins can configure automatic marketplace and plugin installation via .pi/generated/source/settings/claude-settings.json:
...
- Clear cache: rm -rf ~/.pi/claude-compat/plugins/cache
