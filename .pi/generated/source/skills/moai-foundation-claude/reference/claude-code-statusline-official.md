...
Add statusline configuration to .pi/generated/source/settings/claude-settings.json:
...
{
  "statusLine": {
    "command": "~/.pi/claude-compat/scripts/my-statusline.sh"
  }
}
```
...
{
  "statusLine": {
    "command": "python3 ~/.pi/claude-compat/scripts/status.py --format=minimal"
  }
}
```
