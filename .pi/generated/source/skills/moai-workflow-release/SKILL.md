...
description: >
  ...
  failures escalate to expert-debug. Extracted from .claude/commands/99-release.md
...
- Template/rules file optimization (`.pi/generated/source/rules/`, `.pi/generated/source/skills/`, `.claude/agents/`)
