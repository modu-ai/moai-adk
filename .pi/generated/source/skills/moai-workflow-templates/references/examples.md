...
```json
{
  ...
  "user_customizations_preserved": [
    ...
    {
      "file": ".pi/generated/source/settings/claude-settings.json",
      "preserved_fields": [
        "permissions.allow",
        "permissions.deny"
      ]
  ...
  "conflicts_resolved": [
    {
      "file": ".pi/generated/source/moai-config/sections/quality.yaml",
...
```bash
# 잘못된 예시 - 템플릿 직접 수정
vim .pi/generated/source/skills/moai-workflow-templates/modules/code-templates.md
# → MoAI-ADK 업데이트 시 충돌
# → 팀원 간 불일치
```
