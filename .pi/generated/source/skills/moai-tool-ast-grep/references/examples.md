  ...
  ast-grep:
    ...
    steps:
      ...
      - name: Run Security Scan
        run: sg scan --config .pi/generated/source/skills/moai-tool-ast-grep/rules/sgconfig.yml --format github
...
sg scan --config .pi/generated/source/skills/moai-tool-ast-grep/rules/sgconfig.yml --format compact
...
sg scan --config .pi/generated/source/skills/moai-tool-ast-grep/rules/sgconfig.yml --severity error
