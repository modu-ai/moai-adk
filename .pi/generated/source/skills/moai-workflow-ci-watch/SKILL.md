...
description: CI watch loop skill — monitors gh pr checks after /moai sync PR creation, classifies required vs auxiliary failures, emits ready-to-merge handoff or T3 expert-debug trigger. HARD invocation contract in .pi/generated/source/rules/moai/workflow/ci-watch-protocol.md.
version: "1.0.0"
tools: Bash,Read
level1_tokens: 120
level2_tokens: 4800
triggers:
  ...
  - "check.*status.*PR"
paths:
  - ".pi/generated/source/rules/moai/workflow/ci-watch-protocol.md"
---
...
- `.pi/generated/source/rules/moai/workflow/ci-watch-protocol.md` (HARD invocation contract)
