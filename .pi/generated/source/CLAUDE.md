...
Core principles (1-4) and six Agent Core Behaviors (consolidated cross-cutting rules) are defined in .pi/generated/source/rules/moai/core/moai-constitution.md. Development safeguards (5-9) are detailed in Section 7.
...
For detailed design rules, see .pi/generated/source/rules/moai/design/constitution.md
...
For detailed agent descriptions, see the Agent Catalog section above. For agent creation guidelines, use the builder-agent subagent or see `.pi/generated/source/rules/moai/development/agent-authoring.md`.
...
For detailed workflow specifications, see .pi/generated/source/rules/moai/workflow/spec-workflow.md
...
For MX protocol details, see .pi/generated/source/rules/moai/workflow/mx-tag-protocol.md

For team-based parallel execution of these phases, see .pi/generated/source/skills/moai/team/plan.md and .pi/generated/source/skills/moai/team/run.md.

---

## 6. Quality Gates

For TRUST 5 framework details, see .pi/generated/source/rules/moai/core/moai-constitution.md
...
Key rules (full detail in `.pi/generated/source/rules/moai/core/askuser-protocol.md`):
...
Agent interaction boundary (full detail in `.pi/generated/source/rules/moai/core/agent-common-protocol.md`):
...
MoAI-ADK uses Claude Code's official rules system at `.pi/generated/source/rules/moai/`:
...
- **Design rules**: Design system constitution (.pi/generated/source/rules/moai/design/constitution.md)
...
- `.pi/generated/source/rules/moai/design/constitution.md`: FROZEN/EVOLVABLE zone definitions, safety architecture
...
For anti-hallucination policy, see .pi/generated/source/rules/moai/core/moai-constitution.md
...
For MCP configuration and usage patterns, see .pi/generated/source/rules/moai/core/settings-management.md.
...
For core parallel execution principles, see .pi/generated/source/rules/moai/core/moai-constitution.md.
...
For the complete worktree selection decision tree, see .pi/generated/source/rules/moai/workflow/worktree-integration.md
...
For complete Agent Teams documentation including team API reference, role profiles, file ownership strategy, team workflows, and configuration, see .pi/generated/source/rules/moai/workflow/spec-workflow.md and .moai/config/sections/workflow.yaml.
