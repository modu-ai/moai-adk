---
name: moai-docs-unified-integration
...
{
  "scripts": {
    "docs:validate": "bash -c 'uv run .claude/skills/moai-docs-unified/scripts/lint_korean_docs.py && uv run .claude/skills/moai-docs-unified/scripts/validate_mermaid_diagrams.py'",
    "docs:report": "uv run .claude/skills/moai-docs-unified/scripts/generate_final_comprehensive_report.py",
...
COPY .claude/skills/moai-docs-unified/scripts /scripts
...
**End of Module** | moai-docs-unified-integration
