...
## Adaptive Thinking (Opus 4.7+ built-in, including Opus 5.5 and 4.8)

The model's built-in reasoning mode (Opus 4.7 and later, including Opus 5.5 and 4.8) that dynamically allocates reasoning tokens based on task complexity.
...
| Adaptive Thinking | Automatic | Opus 4.7+ built-in (incl. Opus 5.5 and 4.8) | YES |
