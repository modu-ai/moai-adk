# Skill: Context7 Integration Expert
...
```python
# docs-manager agent
Skill("moai-context7-integration")

# Research best practices for technology stack
context7_expert = Context7IntegrationExpert()

# Get latest documentation for multiple libraries
library_docs = await context7_expert.get_library_documentation([
    'react',
    'nextjs',
    'typescript'
])
...
enhanced_content = await context7_expert.enhance_mdx_content(
    content=original_mdx,
    libraries=['react', 'nextjs']
)

# Validate documentation quality
validation = await context7_expert.validate_documentation('./docs')
```

### CLI Integration

```bash
# Update documentation with latest Context7 data
npx @alfred/context7-integrator update --docs ./docs --libraries react,nextjs

# Validate documentation against latest standards
npx @alfred/context7-validator check --docs ./content --strict

# Research best practices for technology stack
npx @alfred/context7-research analyze --stack "react,nextjs,typescript" --report ./research.md

# Generate comparison report
npx @alfred/context7-compare compare --libraries "react,vue,angular" --criteria performance,ecosystem
```

## 📚 Reference Materials

- [Context7 Official Documentation](https://context7.com/docs)
- [Context7 API Reference](https://api.context7.com/v1/docs)
- [Context7 Best Practices Guide](https://context7.com/guides/best-practices)
- [Claude Code Context7 Integration](https://docs.anthropic.com/claude/docs/context7)
