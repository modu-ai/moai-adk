...
|--------|---------|----------|
| `workflow` | Core workflow command processors | workflow-spec, manager-ddd |
...
| `manager-ddd` | `/moai:2-run` | DDD ANALYZE-PRESERVE-IMPROVE execution |
