...
class TestPerformanceBenchmarks(unittest.TestCase):
    ...
    def test_documentation_generation_performance(self):
        ...
        result, gen_time = self.measure_time(
            self.project.generate_documentation_from_spec,
            spec_data
        )
        ...
        print(f"✅ Documentation generated in {gen_time:.2f} seconds with {len(spec_data['requirements'])} requirements")
...
{{% endif %}}
    ...
    def test_large_project_handling(self):
        ...
        dirs_to_create = [
            "src/backend/module1", "src/backend/module2", "src/frontend/components",
            "docs/api", "docs/guides", "tests/unit", "tests/integration",
            "config/dev", "config/prod", "scripts/deploy"
        ]
