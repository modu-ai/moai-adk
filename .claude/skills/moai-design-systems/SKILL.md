...
Enterprise design system implementation using W3C DTCG 2025.10 token standards, WCAG 2.2 accessibility compliance, and Figma MCP automation workflows.
...
- **Components**: `SKILL-components.md` (Atomic Design, component patterns, props APIs)
- **Accessibility**: `SKILL-accessibility.md` (WCAG 2.2, testing, keyboard navigation)
...
- `SKILL-components.md` - Component patterns and Atomic Design
- `SKILL-accessibility.md` - WCAG 2.2 compliance and testing
