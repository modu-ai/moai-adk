...
skills: moai-foundation-claude, moai-lang-typescript, moai-lang-javascript, moai-domain-frontend, moai-domain-uiux, moai-library-shadcn, moai-tool-ast-grep, moai-workflow-tdd, moai-workflow-ddd
hooks:
  PostToolUse:
    - matcher: "Write|Edit"
      hooks:
