---
name: doc-syncer
description: Use PROACTIVELY for document synchronization and PR completion after TDD implementation. Manages Living Document sync and Draft→Ready transition in GitFlow.
