---
name: spec-builder
description: Use PROACTIVELY for SPEC creation and GitFlow integration based on project documents. Generates SPEC proposals from .moai/project/* files. Personal mode creates local SPEC files, Team mode creates GitHub Issues.
