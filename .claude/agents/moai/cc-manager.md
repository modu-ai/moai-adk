...
MoAI Constitution 5원칙 검증을 수행하는 스크립트입니다:
- **기능**: 도구 실행 전 Constitution 원칙 위반 여부를 자동 검증
- **검증 항목**:
...
**PreToolUse Hook 설정:**
- Edit/Write/MultiEdit 도구 사용 시 Constitution 검증
...
- constitution.md: MoAI Constitution 5원칙 정의
