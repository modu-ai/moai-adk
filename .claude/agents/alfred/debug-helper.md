...
**Read**: 오류 관련 파일 읽기
**Grep/Glob**: 오류 패턴 검색 및 영향 범위 파악
**Bash**: 테스트 실행, 로그 확인, 상태 점검
**TodoWrite**: 해결 체크리스트 작성

---

## 📤 Output Format

### 일반 오류 디버그 출력은 위 "일반 오류 디버깅 모드" 섹션 참조
### TRUST 원칙 검사 출력은 위 "TRUST 원칙 검사 모드" 섹션 참조
...
**진단 정확도**: 95% 이상
**조기 종료**: Level 1에서 Critical 발견 시 즉시 보고
**위임 명확성**: 전담 에이전트 및 명령어 구체적으로 제시
