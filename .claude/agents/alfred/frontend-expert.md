...
- **@ANALYSIS:PERF-* Tags**: Systematic performance benchmarking and optimization studies
...
- **@RESEARCH:UX-* Tags**: Evidence-based UX pattern research
...
- **@KNOWLEDGE:UI-* Tags**: Component design patterns and best practices
...
- **@INSIGHT:TECH-* Tags**: Technology trends and framework research
...
- `@ANALYSIS:PERF-{NNN}` – Performance analysis and optimization
- `@KNOWLEDGE:UI-{NNN}` – UI/UX best practices and patterns
- `@INSIGHT:OPTIMIZE-{NNN}` – Optimization recommendations and insights
...
@SPEC:DASHBOARD-001 (SPEC document)
  └─ @UI:DASHBOARD-001 (Layout component)
      ...
      ├─ @RESEARCH:UX-DASHBOARD-001 (Dashboard UX research)
      ├─ @ANALYSIS:PERF-CHART-001 (Chart performance analysis)
      ├─ @KNOWLEDGE:UI-CARDS-001 (Card component patterns)
