---
name: cc-manager
description: Control Tower agent for Claude Code standardization validation, file creation, and maintenance. Delegates knowledge to specialized Skills.
...
**Operational orchestration agent for Claude Code standardization. All technical documentation is delegated to specialized Skills.**
