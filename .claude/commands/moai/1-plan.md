...
## 7-Phase Feature Development Planning Workflow

This workflow integrates comprehensive planning from the feature-dev plugin pattern:
...
Process:
- Analyze user request for explicit requirements
- Identify implicit requirements based on domain knowledge
- Surface assumptions using AskUserQuestion for clarification
- Determine feature complexity level (simple, medium, complex)

Deliverables:
- Requirements summary
- Assumptions list (validated with user)
- Initial scope assessment
- Complexity classification

### PHASE 2: Codebase Exploration - Parallel Agents for Architecture Mapping
...
Step 1: Split exploration into parallel tracks

Track A - File Structure Discovery:
- Use Explore agent for directory analysis
- Find relevant files by keywords
- Locate existing SPEC documents
- Identify implementation patterns

Track B - Pattern Analysis:
- Use domain-specific agent (expert-backend, expert-frontend, etc.)
- Analyze existing patterns in relevant domain
- Identify architectural conventions
- Document integration requirements

Track C - Dependency Mapping:
...
- Combine findings from all parallel tracks
- Create unified architecture understanding
- Identify potential conflicts or constraints

Deliverables:
- Architecture map showing relevant components
- Integration point identification
- Pattern library for consistent implementation
- Risk areas and constraints

### PHASE 3: Clarifying Questions - Identify Ambiguities

Goals:
- Surface hidden assumptions
- Resolve unclear requirements
- Validate approach before detailed planning
...
Step 2: Batch Questions Efficiently

Use AskUserQuestion with max 4 questions per batch:
- Group related questions together
- Provide context for each question
- Use concrete examples in options
- Allow multi-select where appropriate

Step 3: Document Answers

Record validated decisions in planning document:
- Create decision log
- Document rationale for each choice
- Note constraints from answers

Deliverables:
- Decision log with all validated choices
- Updated requirements with clarifications
- Constraint list from user answers
- Risk assessment based on clarifications

### PHASE 4: Architecture Design - Generate Multiple Approaches

Goals:
- Create multiple implementation approaches
- Evaluate trade-offs between approaches
- Select optimal approach with user input

Process:

Step 1: Generate Approaches

Create minimum 3 distinct approaches:

Approach A - Conservative:
- Minimal changes to existing architecture
- Proven technologies and patterns
- Lower risk, slower delivery
- Example: "Incremental refactoring with existing stack"

Approach B - Balanced:
- Moderate architectural changes
- Mix of proven and new technologies
- Balanced risk and delivery speed
- Example: "New module with established patterns"

Approach C - Aggressive:
- Significant architectural improvements
- Latest technologies and patterns
- Higher risk, faster long-term delivery
- Example: "Complete rewrite with modern framework"

Step 2: Trade-off Analysis

Score each approach across criteria:
- Implementation Time (days/weeks)
- Complexity (Low/Medium/High)
- Risk Level (Low/Medium/High)
- Maintainability (1-10 score)
- Performance Impact (1-10 score)
- Scalability (1-10 score)
...
- Allow user to choose or hybridize
...
### PHASE 5: Implementation Plan - Create Detailed Task Breakdown

Goals:
- Decompose selected approach into actionable tasks
...
- Mark parallel task opportunities
...
### PHASE 6: Validation Plan - Define Acceptance Criteria
...
Format scenarios with Given/When/Then:
- Given: Pre-conditions and context
- When: Action or event
- Then: Expected outcome

Step 2: Quality Gate Definition
...
Step 3: Validation Method Specification
...
### PHASE 7: Documentation - Documentation Plan

Goals:
- Plan documentation deliverables
- Define documentation audiences
- Schedule documentation creation
...
- End users (feature usage)
- Developers (implementation details)
- Operators (deployment and monitoring)
- Maintainers (architecture and design)

Step 3: Documentation Schedule
...
The 7-phase workflow replaces and enhances the existing PHASE 1 (Project Analysis and SPEC Planning):

Original PHASE 1 becomes 7-phase comprehensive planning:
- PHASE 1: Discovery (user request analysis)
- PHASE 2: Codebase Exploration (parallel agent execution)
- PHASE 3: Clarifying Questions (assumption validation)
- PHASE 4: Architecture Design (approach generation)
- PHASE 5: Implementation Plan (task breakdown)
- PHASE 6: Validation Plan (acceptance criteria)
- PHASE 7: Documentation (documentation planning)

After completing all 7 phases:
- Proceed to original PHASE 2 (SPEC Document Creation)
- Continue with original PHASE 3 (Git Branch and PR Setup)
...
1. Start 7-Phase Planning Workflow immediately.
