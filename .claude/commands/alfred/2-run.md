...
After implementation completes, use AskUserQuestion tool to ask the user what to do next:
            ...
            "options": [
                {
                    ...
                    "description": "Run /alfred:3-sync to update Living Documents and TAG system"
                },
                {
                    "label": "🧪 Run additional tests/validation",
                    "description": "Re-run tests or perform additional quality checks"
                },
                {
...
**Important Notes**:
- **ALWAYS use AskUserQuestion** - Never suggest next steps in prose (e.g., "You can now run `/alfred:3-sync`...")
...
**Prohibited Pattern**:
```
❌ "Implementation complete! You can now run `/alfred:3-sync` to synchronize documentation..."
```
