...
After project initialization completes, use AskUserQuestion tool to ask the user what to do next:
    ...
    questions=[
        {
            ...
            "options": [
                {
                    "label": "📋 Start planning specifications",
                    "description": "Run /alfred:1-plan to create SPEC documents"
                },
                {
                    "label": "🔍 Review project structure",
                    "description": "Examine generated documents and configuration"
                },
                {
