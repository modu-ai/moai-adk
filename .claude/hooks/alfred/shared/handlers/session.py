...
def handle_session_start(payload: HookPayload) -> HookResult:
    ...
    # Default to "clear" (minimal output) if phase is missing or invalid
    event_phase = payload.get("phase", "clear")
    if event_phase != "compact":
        # Return minimal valid Hook result for non-compact phases (clear, invalid, missing, etc.)
