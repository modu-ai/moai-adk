...
# @CODE:HOOKS-EMERGENCY-001:IMPORT-FIX | SPEC: SPEC-HOOKS-EMERGENCY-001.md
...
# CRITICAL: Must be set BEFORE imports to prevent ImportError
...
def main() -> None:
    ...
    """
    try:
        # Use CrossPlatformTimeout context manager for 5-second global timeout
