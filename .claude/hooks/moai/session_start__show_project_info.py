    ...
    if HAS_CONTEXT_MANAGER:
        try:
            ...
            if snapshot:
                ...
                # NOTE: Do NOT archive snapshot here.
                # Keep context-snapshot.json available for the entire session
                # so MoAI can read it when user requests session continuation.
                # Archiving happens in PreCompact hook before saving a new snapshot.
