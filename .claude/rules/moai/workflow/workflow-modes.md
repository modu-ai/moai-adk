...
Three-phase SPEC-First workflow supporting DDD, TDD, and Hybrid development methodologies.
...
Agent: manager-ddd
Purpose: Implement specification using the configured development methodology
...
- Methodology: Run phase uses development_mode from quality.yaml

### Run to Sync
- Trigger: Implementation complete, tests passing
- Action: Execute /moai sync SPEC-XXX
- Handoff: SPEC reference, implementation summary, test results, methodology used
...
| Best for | Legacy code | New projects | Mixed codebases |
