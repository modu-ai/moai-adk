...
# ============================================================
# 154-155: SPEC-V3R2-HRN-003 FROZEN 조항 (2026-05-13)
# 154: must-pass firewall (design-constitution §12 Mechanism 3)
# 155: 4-anchor FROZEN set {0.25, 0.50, 0.75, 1.00}
# ============================================================
- id: CONST-V3R2-154
  zone: Frozen
  file: .claude/rules/moai/design/constitution.md
  anchor: "#12-evaluator-leniency-prevention"
  clause: "§12 Mechanism 3 (Must-Pass Firewall) — must-pass dimensions cannot be compensated by high scores in other areas; a failing must-pass dimension causes overall FAIL; this is FROZEN and cannot be evolved. Implemented in internal/harness: applyMustPassFirewall + validateMustPassFloor (ErrMustPassBypassProhibited). MustPass set must include Security floor; REQ-HRN-003-018."
  canary_gate: true
...
- id: CONST-V3R2-155
  ...
  file: .claude/rules/moai/design/constitution.md
  anchor: "#12-evaluator-leniency-prevention"
  clause: "§12 Mechanism 1 (Rubric Anchoring) — anchor set FROZEN at {0.25, 0.50, 0.75, 1.00}; adding a 5th anchor requires CON-002 amendment; non-canonical anchor values in sub-criterion scores are rejected (ErrRubricCitationMissing). Implemented in internal/harness: canonicalAnchors + Rubric.ValidateCitation; REQ-HRN-003-003, REQ-HRN-003-009, REQ-HRN-003-013."
  canary_gate: true
```
