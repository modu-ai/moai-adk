...
ID 형식: `CONST-V3R2-NNN` (초기 namespace) 또는 `CONST-V3R5-NNN` (parallel namespace, SPEC-V3R5-CONSTITUTION-DUAL-001)
...
V3R5 namespace 정책 (SPEC-V3R5-CONSTITUTION-DUAL-001 §3.4 OQ5 결정):
...
# ============================================================
# CONST-V3R5-001..039: 신규 parallel namespace (SPEC-V3R5-CONSTITUTION-DUAL-001)
