...
//
// HARD constraints (design.md §D + anti-patterns):
...
//
// Fail-honest semantics (design.md §D6): a single null lens is tolerated (its gap is named in the
//   synthesis); TWO OR MORE null lenses abort the Synthesize phase and return insufficient_coverage
//   naming the failed lenses — a synthesis over half the lenses would smooth over unknown unknowns.
...
//   research narrative fits headings better than JSON (design.md §D5).
//
// Cross-refs: design.md §D (phase structure + lens/synthesis sketch); REQ-ATR-018/019/020;
//   acceptance.md AC-ATR-023/024/025; dynamic-workflows.md (16-concurrent cap, user-owned workflows).
//
// Usage:
...
// hard cap: at most 4 lenses (design.md §D + REQ-ATR-020) — a fifth lens is silently dropped
...
// (A single null lens is tolerated below — its gap is named for the synthesizer; edge case E5.)
