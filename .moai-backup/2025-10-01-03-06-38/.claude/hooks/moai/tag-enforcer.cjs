 ...
 * CHAIN: REQ:TAG-SYSTEM-001 -> DESIGN:CODE-FIRST-001 -> TASK:ENFORCER-001 -> @DOC:SECURITY:TAG-ENFORCER-001
 * DEPENDS: NONE
 * STATUS: active
 * CREATED: 2025-09-29
 * @IMMUTABLE
 ...
 * - 새로운 @DOC:CATEGORY:DOMAIN-ID 형식 검증
 * - AI-TAG 카테고리 지원
 * - 체인 및 의존성 검증
 */
...
const CODE_FIRST_PATTERNS = {
  ...
  // 핵심 TAG 라인들
  MAIN_TAG: /^\s*\*\s*@DOC:([A-Z]+):([A-Z0-9-]+)\s*$/m,
