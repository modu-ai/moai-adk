...
MoAI-ADK 是专为 Claude Code 打造的**高性能 AI 开发环境**。24 个专业 AI 智能体与 52 个技能协同工作，助力产出高质量代码。新项目和功能开发默认采用 TDD，覆盖率低于 10% 的现有项目自动采用 DDD，并支持 Sub-Agent 与 Agent Teams 双执行模式。
...
- **85-100%** 测试覆盖率
- **24 个**专业 AI 智能体 + **52 个**技能
- **18 种**编程语言支持
- **25 个** Claude Code 钩子事件
...
MoAI 是一个**战略编排器**。它不直接编写代码，而是将任务委托给 24 个专业智能体。
...
| **Team** | 5 | reader, coder, tester, designer, validator | 并行团队协作开发 |
...
MoAI-ADK 根据您的 Claude Code 订阅方案，为 24 个智能体分配最优 AI 模型。在方案的速率限制内最大化质量。
