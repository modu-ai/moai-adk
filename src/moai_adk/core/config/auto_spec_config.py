...
class AutoSpecConfig:
    ...
    def load_config(self) -> None:
        ...
        try:
            ...
            self.config = self.config.get('tags', {}).get('policy', {}).get('auto_spec_completion', {})
    ...
    def save_config(self) -> None:
        ...
        try:
            ...
            if 'tags' not in full_config:
                full_config['tags'] = {}
            if 'policy' not in full_config['tags']:
                full_config['tags']['policy'] = {}
            full_config['tags']['policy']['auto_spec_completion'] = self.config
