...
pip install moai-essentials-unified

# Or install with all dependencies
pip install moai-essentials-unified[complete]

# Verify installation
moai-essentials-unified --version
```
...
moai-essentials-unified --workflow complete --target ./src/

# Performance profiling
moai-essentials-unified --component profiler --gpu-profiling

# Technical debt analysis
moai-essentials-unified --component refactorer --analyze-debt

# Security scanning
moai-essentials-unified --component reviewer --security-scan
```
...
### Development Setup
```bash
git clone https://github.com/moai-adk/moai-essentials-unified.git
cd moai-essentials-unified
pip install -e ".[dev]"
...
- **Issues**: [GitHub Issues](https://github.com/moai-adk/moai-essentials-unified/issues)
- **Discussions**: [GitHub Discussions](https://github.com/moai-adk/moai-essentials-unified/discussions)
