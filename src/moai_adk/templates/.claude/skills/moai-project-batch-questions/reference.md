      ...
      options: [
        {
          ...
          description:
            "All sub-agent prompts in English. Reduces token usage by 15-20%",
          value: "english",
          recommended: true,
        },
        {
          ...
          description:
            "All sub-agent prompts in your selected language for local efficiency",
          value: "localized",
        },
      ],
    },
      ...
      options: [
        {
          ...
          description:
            "Type your preferred name using the 'Other' option below",
          value: "custom",
        },
      ],
      validation: {
...
export const TEAM_MODE_BATCH_TEMPLATE: BatchTemplate = {
  ...
  questions: [
    {
      question:
        "[Team Mode] Is 'Automatically delete head branches' enabled in your GitHub repository settings?",
    ...
    {
      question:
        "[Team Mode] Which Git workflow should we use when creating SPEC documents?",
      header: "Git Workflow",
      multiSelect: false,
      options: [
        {
        ...
        },
        {
          ...
          description:
            "브랜치 생성 없이 develop에 직접 커밋. 빠른 프로토타이핑에 최적",
...
Choice affects future /moai:3-sync execution time and costs.`,
      ...
      options: [
        {
          ...
          description: "Version control for schema",
        },
  ...
  questions: [
    {
      ...
      validation: {
        ...
        errorMessage:
          "Project name must be 3-50 characters, alphanumeric and spaces only",
      },
    },
  ],
};
...
async function handleProjectInitialization() {
  ...
  const langResult = await executeBatchTemplate(
    LANGUAGE_BATCH_TEMPLATE,
    context
  );
  ...
  if (context.mode === "team") {
    const teamResult = await executeBatchTemplate(
      TEAM_MODE_BATCH_TEMPLATE,
      context
    );
  }
