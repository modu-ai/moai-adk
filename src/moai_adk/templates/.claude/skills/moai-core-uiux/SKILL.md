...
- `moai-nextra-architecture` - Documentation generation
- `moai-lib-shadcn-ui` - shadcn/ui specialized patterns (complementary)
...
**moai-lib-shadcn-ui** (partially) → [Component Architecture](modules/component-architecture.md) + [Theming System](modules/theming-system.md)
- shadcn/ui patterns
- Theme system
- Component composition

**Note**: `moai-lib-shadcn-ui` remains as a complementary skill for shadcn/ui-specific advanced patterns.
