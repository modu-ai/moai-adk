...
tools: Read, Write, Edit, Grep, Glob, WebFetch, WebSearch, Bash, TodoWrite, Task, Skill, mcp__context7__resolve-library-id, mcp__context7__get-library-docs, mcp__claude-in-chrome__*, mcp__figma__get-file-data, mcp__figma__create-resource, mcp__figma__export-code, mcp__sequential-thinking__sequential_thinking
model: inherit
