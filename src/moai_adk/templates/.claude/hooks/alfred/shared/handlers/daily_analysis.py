...
def run_session_analyzer(cwd: str) -> bool:
    ...
    """
    try:
        # Use absolute path to session_analyzer.py in Hook scripts directory
        # This file: .claude/hooks/alfred/shared/handlers/daily_analysis.py
        # Target:   .claude/hooks/alfred/shared/scripts/session_analyzer.py
        script_path = Path(__file__).parent.parent / "scripts" / "session_analyzer.py"
