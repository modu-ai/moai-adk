...
| ---------- | -------------------------------------------------------------------------------- | ---------- |
| **v0.4.10** | 🎉 Skills v2.0 สมบูรณ์แบบ (100% Production-Ready) + 85,000 บรรทัดเอกสารทางการ + 300+ ตัวอย่าง TDD | 2025-10-22 |
...
> 📦 **ติดตั้งตอนนี้**: `pip install moai-adk==0.4.10` หรือ `uv tool install moai-adk==0.4.10`
...
| **PyPI Package**         | https://pypi.org/project/moai-adk/ (ล่าสุด: v0.4.10)       |
