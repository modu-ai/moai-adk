...
MoAI-ADK (Agentic Development Kit) 완전한 한국어 온라인 문서에 오신 것을 환영합니다. 이 문서 시스템은 초보자도 쉽게 MoAI-ADK를 이해하고 시작할
수 있도록 구성되었습니다.
...
4. **[첫 10분 실습](guides/alfred/1-plan.md#%EC%B2%AB-10%EB%B6%84-%EC%8B%A4%EC%8A%B5-hello-world-api)**
   \- 실제로 만들어보기
