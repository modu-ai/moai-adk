...
1. **[Stage 2: TDD Implementation](guides/workflow/2-build.md)** - `/alfred:2-build` 실행
2. **[EARS Guide](guides/concepts/ears-guide.md)** - EARS 작성법 상세
3. **[SPEC Metadata](guides/concepts/spec-metadata.md)** - 메타데이터 필드 상세
