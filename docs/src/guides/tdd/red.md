...
1. [RED 단계의 철학적 배경](#red-단계의-철학적-배경)
2. [RED 단계의 중요성](#red-단계의-중요성)
3. [실패하는 테스트 작성 방법](#실패하는-테스트-작성-방법)
4. [테스트 케이스 설계 전략](#테스트-케이스-설계-전략)
5. [경계 값 테스트와 예외 케이스](#경계-값-테스트와-예외-케이스)
6. [실전 코드 예시](#실전-코드-예시)
7. [일반적인 실수와 방지 방법](#일반적인-실수와-방지-방법)
8. [Git 커밋 전략 (RED 단계)](#git-커밋-전략-red-단계)
9. [RED 단계 체크리스트](#red-단계-체크리스트)
...
**기억하세요: 좋은 RED 단계는 성공적인 TDD의 절반입니다!** <span class="material-icons">target</span>
