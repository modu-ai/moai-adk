...
1. [GREEN 단계의 목표와 원칙](#green-단계의-목표와-원칙)
2. [최소 구현 전략 (YAGNI 원칙)](#최소-구현-전략-yagni-원칙)
3. [테스트 통과를 위한 빠른 해결책](#테스트-통과를-위한-빠른-해결책)
4. [성능 vs 기능 구현 균형](#성능-vs-기능-구현-균형)
5. [실전 코드 예시](#실전-코드-예시)
6. [GREEN 단계에서 피해야 할 것들](#green-단계에서-피해야-할-것들)
7. [Git 커밋 전략 (GREEN 단계)](#git-커밋-전략-green-단계)
8. [GREEN 단계 체크리스트](#green-단계-체크리스트)
