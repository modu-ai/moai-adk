...
| debug-helper 🔍     | Sonnet | 失败分析、forward-fix 策略                   |
...
| ------------------- | ------ | ------------------------------------- | ------------------------------------------------------------------ |
| backend-expert 🔧   | Sonnet | 后端架构、API 设计、DB               | 'backend', 'api', 'server', 'database', 'deployment', 'authentication' |
