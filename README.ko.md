...
- **🔵 DDR 지원**: 기존 코드베이스 개선을 위한 Domain-Driven Refactoring
...
`.moai/config/sections/quality.yaml`의 `development_mode` 설정에 따라 TDD 또는 DDR로 라우팅됩니다:
...
| **manager-ddr**         | DDR 리팩토링 실행      | `/moai:2-run` (development_mode: ddr 일 때)  |
