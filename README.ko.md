...
**Available Languages:** [English](./README.md) | [한국어](./README.ko.md) | [日本語](./README.ja.md)
...
설치 또는 업그레이드 후, 프로젝트를 초기화하고 구성하기 위해 `/alfred:0-project`를 실행**해야 합니다**.
...
`/alfred:0-project` 명령은 자동으로 다음 작업을 수행합니다:
