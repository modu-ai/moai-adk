...
**🌏 Languages**: 🇰🇷 한국어 | [🇺🇸 English](./README.md) | [🇯🇵 日本語](./README.ja.md) | [🇨🇳 中文](./README.zh.md) | [🇹🇭 ไทย](./README.th.md)
...
- [Meet Alfred](#meet-alfred---ai-에이전트-생태계)
...
| **language-detector** 🔍      | 언어 감지        | 프로젝트 환경 분석, 도구 체인 선택   |
| **project-interviewer** 💬    | 프로젝트 인터뷰  | 사용자 요구사항 도출, 대화형 설계    |
| **backup-merger** 🔄          | 백업 병합        | 충돌 해결, 백업 복구 전략 수립      |
| **feature-selector** 🎯       | 기능 선택        | 기능 우선순위 분석, 의사결정 지원   |
| **document-generator** 📝     | 문서 생성        | 프로젝트 문서 자동 생성, 템플릿 작성 |
| **template-optimizer** ⚡     | 템플릿 최적화    | 템플릿 분석, 최적화 전략 수립       |
...
| ------------------- | ------------------------------------------------------------- | -------------------------- | ---------------------------------------- | --------- |
| `/alfred:0-project` | project-manager 📂 + 6 Sub-agents                                             | 세션 기본 모델             | 프로젝트 전략 수립, 복잡한 의사결정      | 1~2분     |
