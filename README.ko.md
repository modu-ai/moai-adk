...
- **101개의 프로덕션급 스킬** (모든 개발 영역 커버)
  ...
  - **신규: 고급 MCP 통합**: Context7, Playwright, Sequential-thinking 서버
  - **신규: 문서 처리**: AI 기반 문서 핸들링 (docx, pdf, pptx, xlsx)
  - **신규: 아티팩트 빌더**: 모던 React/Tailwind/shadcn/ui 컴포넌트 생성
  - **신규: 내부 커뮤니케이션**: 기업 커뮤니케이션 템플릿 및 자동화
  - **신규: MCP 빌더**: 고급 Model Context Protocol 서버 개발
