    ...
    def test_language_configuration_pass_through(self, command_files):
        ...
        for cmd_name, cmd_path in command_files.items():
            ...
            if "AskUserQuestion" in content:
                ...
                assert "question" in ask_section, \
...
class TestCommandSpecificOptions:
    ...
    def test_0_project_options(self):
        ...
        Verify that /alfred:0-project provides correct 3 options:
        1. Proceed to /alfred:1-plan
    ...
    def test_1_plan_options(self):
        ...
        Verify that /alfred:1-plan provides correct 3 options:
        1. Proceed to /alfred:2-run
        2. Revise SPEC
        3. Start new session
        """
    ...
    def test_2_run_options(self):
        ...
        Verify that /alfred:2-run provides correct 3 options:
        1. Proceed to /alfred:3-sync
    ...
    def test_3_sync_options(self):
        ...
        Verify that /alfred:3-sync provides correct 3 options:
        1. Return to /alfred:1-plan (next feature)
        2. Merge PR
        3. Complete session
        """
