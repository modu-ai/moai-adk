...
class TestContentStructure:
    ...
    def test_has_quick_reference(self, skill_content):
        ...
        assert any(term in skill_content for term in ['Quick Reference', 'quick reference', 'Overview']), \
               "Missing Quick Reference or similar section"

    def test_has_when_to_use_section(self, skill_content):
        """Verify When to Use section."""
        assert any(term in skill_content for term in ['When to Use', 'Use Cases', 'Scenarios']), \
               "Missing When to Use section"

    def test_has_best_practices(self, skill_content):
        """Verify Best Practices section."""
        assert any(term in skill_content for term in ['Best Practices', 'DO', 'DON\'T', 'bes practices']), \
    ...
    def test_has_implementation_details(self, skill_content):
        ...
        assert any(term in skill_content for term in ['Implementation', 'Code Example', 'Pattern', 'Framework']), \
