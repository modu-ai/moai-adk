...
class TestFileStructure:
    ...
    def test_skill_has_quick_reference(self, skill_content):
        ...
        assert "Quick Reference" in skill_content or "quick-reference" in skill_content, \
    ...
    def test_skill_has_best_practices(self, skill_content):
        ...
        assert "DO" in skill_content and "DON'T" in skill_content, \
...
class TestContentQuality:
    ...
    def test_description_explains_consolidation(self, skill_metadata, quality_skill_name):
        ...
        assert 'consolidat' in description.lower() or 'compre' in description.lower(), \
...
class TestIntegrationCompleteness:
    ...
    def test_consolidates_source_skills(self, skill_metadata, quality_skill_name):
        ...
        consolidation_map = {
            ...
            'moai-quality-security': ['owasp', 'authentication', 'authorization', 'api-security', 'encryption', 'secrets', 'compliance'],
