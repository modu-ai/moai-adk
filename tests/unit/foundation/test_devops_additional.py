...
class TestContainerOrchestratorAdditional:
    ...
    def test_plan_kubernetes_deployment_with_health_checks(self):
        ...
        has_rolling_update = (
            "rolling_update_strategy" in plan and
            plan["rolling_update_strategy"]["type"] == "RollingUpdate"
        ) or (
            "rolling_update_strategy" in health_checks and
            health_checks["rolling_update_strategy"]["type"] == "RollingUpdate"
        )
