...
"""
    ...
    def test_should_trigger_spec_completion_write_tool(self):
        ...
        tool_args = {
            'file_path': self.test_code_file,
            'content': self.test_code_content
        }
    ...
    def test_should_trigger_spec_completion_with_existing_spec(self):
        ...
        result = should_trigger_spec_completion('Write', {
            'file_path': self.test_code_file,
            'content': self.test_code_content
        })
    ...
    def test_hook_main_execution_flow(self):
        ...
        with patch.object(self.hook, 'should_trigger_spec_completion') as mock_trigger, \
