...
class Handler(http.server.BaseHTTPRequestHandler):
 ...
 def do_POST(self):
  ...
  if idx==1:
   block={'type':'tool_use','id':'toolu_fixture_agent','name':'Agent','input':{'description':'Synthetic identity probe','prompt':'Reply only CHILD_IDENTITY_OK. Do not use tools.','subagent_type':'Explore'}};stop='tool_use'
...
(base/'agent-identity-result.json').write_text(json.dumps(result,indent=2)+'\n')
