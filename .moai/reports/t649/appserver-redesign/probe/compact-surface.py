...
server.shutdown()
result['success']=len(result['invocations'])==2 and result['invocations'][1]['new_request_count']>0 and result['invocations'][1]['exit_code']==0
(base/'compact-surface-result.json').write_text(json.dumps(result,indent=2)+'\n')
