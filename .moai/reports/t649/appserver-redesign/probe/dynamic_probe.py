#!/usr/bin/env python3
import subprocess,os,json,time,selectors,signal,pathlib
...
try:
 ...
 result['process_exit']=p.returncode;result['duration_seconds']=round(time.monotonic()-started,2)
 (base/'dynamic-result.json').write_text(json.dumps(result,indent=2)+'\n')
