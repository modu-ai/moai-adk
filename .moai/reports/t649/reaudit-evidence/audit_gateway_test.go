...
type reauditHistory struct{}
func(reauditHistory)Check(context.Context,string,string,[]byte)error{return nil}
func(reauditHistory)Publish(context.Context,string,string,[]byte)error{return nil}
func TestAuditNativeEgressPreservesOpaqueItemBytes(t *testing.T){
 ...
 store,ref,gen:=oaiStore(t);cfg:=oaiConfig(tr);cfg.Subscription=store;cfg.Limits.History=reauditHistory{}
