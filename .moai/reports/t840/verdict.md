...
2. **400 family `4d15208b-4b88-4cad-a493-0f50d8a8d87b`**: 리드 지시에 따라 기록한다. 리드 확인(2026-09-14) 결과 이것은 **세션 id이지 커밋이 아니다** — 이전 lane-10 세션의 id로, integration holder id·receipt family/source id로도 보고된 바 있다. 본 문서 초판이 앞 8자리(`4d15208b`)만 받아 커밋·파일로 resolve를 시도해 실패한 것은 참조 축 오독이었다(초판 문구는 이 정정으로 대체된다).
