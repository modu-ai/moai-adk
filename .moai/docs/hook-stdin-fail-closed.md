...
Operator document identified in the hook's own denial reason as
`moai-doc:hook-stdin-fail-closed`. When a hook denies a decision with that
identifier, this page explains what happened and how to recover.
...
document's identifier. It carries no recovery steps and none of the failing
