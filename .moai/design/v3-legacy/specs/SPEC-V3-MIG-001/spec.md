...
- **SPEC-V3-CLN-001/002** (내부 cleanup — other writer) — cleanup은 M03/M04/M05로 migration 형태로 배포
- 미래 모든 v3.x / v4.x breaking change

### 9.3 Related

- **SPEC-V3-HOOKS-001~006** — Hook Protocol v2 배포 시 기존 hook wrapper 업그레이드 migration 잠재 필요 (확정 시 각 HOOKS SPEC §9.1 Blocked by로 이동)
