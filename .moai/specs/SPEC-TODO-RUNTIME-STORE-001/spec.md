---
id: SPEC-TODO-RUNTIME-STORE-001
title: "Todo DB의 실행 시작·카드 할당 기록 통합"
version: "0.1.0"
status: completed
created: 2026-09-12
updated: 2026-09-12
...
tags: "todo, runtime, sqlite, factory"
tier: M
related_specs: [SPEC-TODO-UNIFIED-001]
---

# SPEC-TODO-RUNTIME-STORE-001

## HISTORY

| 날짜 | 버전 | 내용 |
|---|---|---|
| 2026-09-12 | 0.1.0 | t648 umbrella의 첫 persistence slice. 4 REQ/4 AC, 별도 구현 게이트 |

## 목적

실제 현재 실행 기록 API의 입력을 Todo 큐와 함께 보존하는 최소 토대를 만든다. 완료/소유권 기능을 선행 구현으로 가정하지 않는다. 이 child 완료만으로 전체 Todo DB 통일이나 t648 완료를 주장하지 않는다.
...
4 AC의 current-tree RED와 구현 후 GREEN·원문출력·HEAD·독립 감사가 필요하다. 운영 데이터 이전이나 사용자 전체23AC 완료는 별도다.
