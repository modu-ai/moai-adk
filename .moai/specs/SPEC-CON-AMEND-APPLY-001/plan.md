...
/usr/bin/grep -rn --include='*.go' 'LoadRegistry(' internal cmd pkg          # expect 7 call sites outside _test.go plus the definition (D4 blast radius)
