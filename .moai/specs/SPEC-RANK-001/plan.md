...
_Note: This phase is implemented in moai-adk repository_

### 4.1 CLI Commands (moai-adk/src/moai_adk/rank/)

- [ ] `moai rank register` - OAuth registration
- [ ] `moai rank status` - Current rank display
- [ ] `moai rank leaderboard` - CLI leaderboard view
- [ ] `moai rank enable/disable` - Toggle collection
