...
author: manager-spec
priority: P1
phase: "v2.20.0-rc1 — Harness governance closeout"
...
- **v2.20.0-rc1 release alignment**: Declare this SPEC's `target_release: v2.20.0-rc1`. The governance artifacts (SPEC + CHANGELOG entry) ship as part of the v2.20.0-rc1 closeout cleanup.
...
| v2.20.0-rc1 release cleanup owner | This SPEC's merge is a documented closeout asset feeding into the rc1 release notes. |
...
|------|------------|------------|
| Downstream SPEC author overlooks this governance SPEC and introduces a fifth `/moai harness` verb without amendment | Medium | REQ-HRN-NS-008 makes silent extension a `plan-auditor` rejection criterion. The governance SPEC is referenced in V3R4-HARNESS-001 plan.md follow-up section and CHANGELOG v2.20.0-rc1 entry, raising discoverability. |
...
| `target_release: v2.20.0-rc1` slips and this SPEC becomes a release-blocking dependency | Low | This SPEC is pure governance with zero LOC code change; it can ship independently of feature-bearing SPECs. If v2.20.0-rc1 slips, target_release rolls forward without functional impact. |
