...
| **M2i — mechanical tail** | Low | `RenderHooks` table update, `make build`, doc comments, codemaps refresh. The tests amended in M2c and M2e are the complete intentional-amendment list (research.md §R1.13); any other existing test that turns red is a regression, not an amendment | regression of the unamended tests | M2d, M2e |
