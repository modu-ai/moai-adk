...
| AC-HCC-002 | NewInstallCmd ≥90% | 87.5% | **FAIL (test-only 도달 불가 — §B.2)** |
| AC-HCC-003 | RunInstall 100% | 100.0% | PASS |
| AC-HCC-004 | runExecuteCommand ≥90% | 100.0% | PASS |
| AC-HCC-005 | runPropose ≥90% | 93.8% | PASS |
| AC-HCC-006 | NewExecuteCmd ≥90% (os.Exit 제외) | 69.2% | **FAIL (test-only 도달 불가 — §B.2)** |
...
### §B.2 — AC-HCC-002 / AC-HCC-006 미달 원인 (spec-internal contradiction — blocker)
