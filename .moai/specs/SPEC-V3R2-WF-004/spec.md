...
- v2 `--mode agent` opt-in escape hatch (master design `docs/design/major-v3-master.md:L967`의 v3.x transition 조치는 본 SPEC scope 외; v2-compat이 필요해질 경우 별도 SPEC에서 처리. REQ-WF004-011은 utility 분류 final state 선언이며 v3.x transition 정책과 무관)
