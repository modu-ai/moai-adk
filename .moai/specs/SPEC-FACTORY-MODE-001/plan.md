...
Version: 0.7.0 | Tier: L | Status: draft | 26 requirements · 36 acceptance-criterion leaves (over the Tier L ceiling of 25 — declared, see `spec.md` §D)
