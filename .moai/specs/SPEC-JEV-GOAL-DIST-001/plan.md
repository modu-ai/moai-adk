...
| N2 OPEN, unowned | `SPEC-JEV-CONSUMERS-001/spec.md` §F (:170) | *"OPEN — blocking M5 and M6"*; carried to CONSUMERS' Kickoff gate, which directed M6 into gate-unrun but left M5 blocked; CONSUMERS is closed `completed`, so N2 has no live owner | `ef3ad83e2` |
