...
- **Plan-phase artifacts**: This commit (frontmatter `version: 1.5.0 → 1.6.0`, `status: completed → in-progress`; HISTORY v1.6.0 row; this Amendments § 2; `plan.md` §I strategy). The `acceptance.md` body refactor is a separate run-phase delegation (manager-develop).
