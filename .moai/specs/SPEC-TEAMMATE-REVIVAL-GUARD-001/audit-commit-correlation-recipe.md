...
> SPEC-TEAMMATE-REVIVAL-GUARD-001 · M3 deliverable · `.moai/docs/` candidate — the
> orchestrator routes placement at sync. Direction-3 (visibility) deliverable of the
> mechanism: the audit rows exist so a revival window is provable after the fact.
