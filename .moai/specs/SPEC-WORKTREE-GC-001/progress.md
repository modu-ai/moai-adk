...
- **Delta decomposition supplement (2026-09-23, lead disclosure)**: the lead's own 09-22 first-pass cleanup removed **9 trees** with full 3-condition verification (merged+pushed+unoccupied) and its own ledger record. The 544→86 delta (458) therefore decomposes as: **26 executor-ledgered + 9 lead-ledgered (verified, ledgered) + ~423 attribution-unknown** (no durable ledger rows anywhere — the operator-disclosure segment is this ~423, not the full ~430+).
