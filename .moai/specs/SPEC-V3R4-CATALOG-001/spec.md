...
| 0.3.2   | 2026-05-16 | manager-develop (run-phase) | status downgrade completed → in-progress — git-implied status 정합성 복원 (SPEC-V3R4-STATUS-DRIFT-FOLLOWUP-001 Wave 3). |
