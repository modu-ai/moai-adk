...
1. **Marketplace Establishment** — Publish moai-adk/moai-cc-marketplace with plugin governance policies
...
- WHEN `/plugin marketplace add moai-adk/moai-cc-marketplace` is executed
...
### Marketplace Structure (moai-adk/moai-cc-marketplace)
...
│   │   └── README.md
│   ├── moai-cc-uiux/                      ← Tailwind + shadcn/ui
│   ├── moai-cc-frontend/                  ← Next.js 16 + React 19.2
│   ├── moai-cc-backend/                   ← FastAPI + uv
│   └── moai-cc-devops/                    ← Vercel/Supabase/Render
...
- ✅ moai-cc-marketplace created (public GitHub repo)
...
- Marketplace.json pins plugin versions (moai-cc-frontend@0.1.0)
