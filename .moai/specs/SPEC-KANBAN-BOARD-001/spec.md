...
tags: "kanban, board, column, wip-limit, state-store, single-origin, worktree-safe, sole-writer, atomicity, branch-side-status, branch-multiplicity, stale-lock, toctou, role-declaration"
tier: L
