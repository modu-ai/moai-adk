...
- Every claimed `file:line` in the delegation brief was independently re-verified against the tree at `d5336214e` on 2026-07-31. All matched; see plan.md §C for the verification table.
