...
| 0.3.3   | 2026-05-16 | manager-develop (FOLLOWUP-002 Wave 2-B-skip) | B6 lint.skip 추가 — walker main 브랜치 전용 스캔으로 feature 브랜치 sync(spec) 커밋 미인식. StatusGitConsistency 임시 skip. PR 머지 후 lint.skip 제거 가능. |
