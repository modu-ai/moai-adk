...
- Amendment requests to `SPEC-UPDATE-YAML-PRESERVE-001` recorded in `spec.md` §I.
- Evidence for `SPEC-UPDATE-TEMPLATE-BASE-SNAPSHOT-001` carried forward in `spec.md` §J.
- Artifacts left uncommitted per the plan-phase brief.
