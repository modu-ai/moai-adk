...
// @MX:WARN: [AUTO] Reads messages in an infinite loop. Termination condition is unclear.
// @MX:REASON: [AUTO] Goroutine may continue running even on error without termination
