...
//
// @MX:NOTE: [AUTO] M6-S4 R-07 thin wrapper — zero local hex constants; color values imported from internal/tui/catppuccin.go
...
//
// @MX:ANCHOR: [AUTO] Theme constructor entry point; fan_in >= 3 (renderer.go NewRenderer, theme_test.go, builder.go)
// @MX:REASON: [AUTO] Public API boundary of the statusline package; thin-re-exports the catppuccin palette via tui.Catppuccin* constants
...
// Color values are thin-imported from internal/tui/catppuccin.go (R-07 mitigation).
