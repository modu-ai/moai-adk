...
var profileSetupTexts = map[string]profileSetupText{
	"en": {
		...
		ModelPolicyHigh:         "Max - Fable 5 (low) + Opus 4.8 (high) + Sonnet (medium~low)",
		ModelPolicyMedium:       "Medium - Opus 4.8 (xhigh~low) + Sonnet (medium~low)",
		ModelPolicyLow:          "Low - Opus 4.8 (high~low) + Sonnet (medium~low)",
