...
var profileSetupTexts = map[string]profileSetupText{
	"en": {
		...
		ModelPolicyHigh:         "High - Opus 5 (high~medium) + Sonnet (low, docs/single-shot rows)",
		ModelPolicyMedium:       "Medium - Opus 5 (high~low) + Sonnet (low, docs/single-shot rows)",
		ModelPolicyLow:          "Low - Opus 5 (high~low) + Sonnet (low, docs/e2e/single-shot rows)",
