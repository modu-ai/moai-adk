...
// TestValidateColor_Positive: validation of valid color formats (positive cases).
// Covers hex, rgb, hsl, and named colors per the DTCG 2025.10 §8.1 color category rules.
...
// TestValidateColor_Negative: validation of invalid color formats (negative cases).
