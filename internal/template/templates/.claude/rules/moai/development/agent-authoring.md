...
| **`.claude/agents/local/`** | **메인테이너 전용 hand-authored agents** (e.g., release-update-specialist, github-specialist; entry via dedicated maintainer harness command wrappers) | user project (maintainer가 author) | **절대 삭제/modify 금지 + 백업 보존** |
