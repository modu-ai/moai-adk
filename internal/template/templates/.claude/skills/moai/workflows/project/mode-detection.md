...
Rationale: SPEC documents generated from the project workflow bypass the plan-audit gate entirely, because that gate runs only in `/moai plan`. Unaudited SPECs accumulate defects that surface much later, during implementation.
