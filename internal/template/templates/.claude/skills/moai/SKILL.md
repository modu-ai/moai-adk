...
Agents: manager-strategy, manager-develop or manager-tdd (per quality.yaml), manager-quality, manager-git
...
Agents: Explore, manager-spec, manager-develop/tdd, manager-quality, manager-docs, manager-git
