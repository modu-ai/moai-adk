...
skills: moai-foundation-claude, moai-foundation-core, moai-workflow-project, moai-workflow-jit-docs, moai-workflow-templates, moai-platform-deployment, moai-framework-electron
hooks:
  PostToolUse:
    - matcher: "Write|Edit"
      hooks:
