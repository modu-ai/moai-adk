...
MoAI-ADK v2.0을 사용하려면 Go 1.25 이상이 필요합니다. 먼저 Go가 설치되어 있는지 확인하세요.
...
Go 1.25 이상이 설치되어 있다면 **[2단계: v1.x 제거하기](#2단계-v1x-제거하기)**로 건너뛰세요.

### Go가 설치되지 않은 경우

Go가 설치되지 않았거나 버전이 1.25 미만인 경우 아래 가이드를 따라 설치하세요:
