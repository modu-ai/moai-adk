// @CODE:PROJ-002 | 
// Related: @CODE:PROJ-002:API, @CODE:PROJ-TPL-001
 ...
 * @tags @CODE:TEMPLATE-MANAGER-001
 */
export class TemplateManager {
   ...
   * @tags @CODE:TEMPLATE-DATA-001:API
   */
   ...
   * @tags @CODE:TEMPLATE-BASE-001:API
   */
   ...
   * @param result - Result object to update
   * @tags @CODE:TEMPLATE-PROJECT-001:API
   */
   ...
   * @param templateData - Template data
   * @param result - Result object to update
   * @tags @CODE:TEMPLATE-PYTHON-001:API
   */
   ...
   * @param templateData - Template data
   * @param result - Result object to update
   * @tags @CODE:TEMPLATE-NODEJS-001:API
   */
   ...
   * @param templateData - Template data
   * @param result - Result object to update
   * @tags @CODE:TEMPLATE-FRONTEND-001:API
   */
   ...
   * @param templateData - Template data
   * @param result - Result object to update
   * @tags @CODE:TEMPLATE-MIXED-001:API
   */
   ...
   * @param templateData - Template data
   * @param result - Result object to update
   * @tags @CODE:TEMPLATE-MOAI-001:API
   */
   ...
   * @param templateData - Template data
   * @param result - Result object to update
   * @tags @CODE:TEMPLATE-CLAUDE-001:API
   */
   ...
   * @tags @CODE:TEMPLATE-FEATURE-001:API
   */
   ...
   * @tags @CODE:TEMPLATE-DIR-001:API
   */
