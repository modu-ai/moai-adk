...
help:
	...
	@echo "  version-bump-patch   - Bump patch version (0.2.1 → 0.2.2)"
	@echo "  version-bump-minor   - Bump minor version (0.2.1 → 0.3.0)"
	@echo "  version-bump-major   - Bump major version (0.2.1 → 1.0.0)"
