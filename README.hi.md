...
| ---------- | ---------------------------------------------------------------------------- | ---------- |
| **v0.4.10** | 🎉 पूर्ण Skills v2.0 पूर्ण (100% Production-Ready) + 85,000 लाइन आधिकारिक दस्तावेज़ + 300+ TDD उदाहरण | 2025-10-22 |
...
> 📦 **अभी इंस्टॉल करें**: `pip install moai-adk==0.4.10` या `uv tool install moai-adk==0.4.10`
...
| **PyPI Package**         | https://pypi.org/project/moai-adk/ (नवीनतम: v0.4.10)      |
