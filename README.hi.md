...
19 AI एजेंट (Alfred SuperAgent 1 + Core Sub-agent 10 + Zero-project Specialist 6 + Built-in Agent 2) मिलकर प्रोजेक्ट की संरचना, निर्णय के कारण, कार्य इतिहास **सभी याद रखते हैं**। एक ही सवाल दोहराने की जरूरत नहीं।
...
| `moai-alfred-tui-survey` | Claude Code Tools AskUserQuestion TUI मेनू मानकीकरण |
...
## v0.4 Series अपडेट (नया!)

| संस्करण | मुख्य सुविधा | तिथि |
| --- | --- | --- |
| **v0.4.6** | 🎉 पूर्ण Skills v2.0 पूर्ण (56/56 100%) + 85,000 लाइन आधिकारिक दस्तावेज़ + 300+ TDD उदाहरण | 2025-10-22 |
| **v0.4.5** | ✅ CI/CD सुधार + बहुभाषी README + तैनाती सफाई | 2025-10-22 |
| **v0.4.4** | हिंदी भाषा समर्थन | 2025-10-21 |
| **v0.4.3** | इंटरैक्टिव प्रश्न उपकरण (TUI मेनू) | 2025-10-21 |
| **v0.4.1** | Skills स्थानीयकरण | 2025-10-21 |
| **v0.4.0** | **55 Claude Skills** + 19 AI टीम + 4-चरण वर्कफ़्लो | 2025-10-21 |

> 📦 **अभी इंस्टॉल करें**: `pip install moai-adk==0.4.6` या `uv tool install moai-adk==0.4.6`
...
| **PyPI Package** | https://pypi.org/project/moai-adk/ (नवीनतम: v0.4.6) |
...
- 📝 License: MIT
- ⭐ Skills: 56/56 पूर्ण (100% उत्पादन-तैयार)
