...
```bash
# विशिष्ट संस्करण में पुनः इंस्टॉल
uv tool install moai-adk
```
...
| `/alfred:9-feedback`      | संवादात्मक रूप से GitHub Issue बनाएं (प्रकार → शीर्षक → विवरण → प्राथमिकता) | GitHub Issue + स्वचालित लेबल + प्राथमिकता + URL |
...
>
> 💡 **v0.7.0+ में नया**: `/alfred:9-feedback` का उपयोग करके विकास के दौरान तुरंत GitHub Issue बना सकते हैं। विकास प्रवाह को बाधित किए बिना पूरी टीम समस्याओं को ट्रैक और चर्चा कर सकती है।
...
| ----------- | ----------------------------------------------------------------------------------------------- | ---------- |
| **v0.8.2**  | 📖 EARS शब्दावली अपडेट: "Constraints" → "Unwanted Behaviors" (स्पष्टता के लिए)                  | 2025-10-29 |
| **v0.8.1**  | 🔄 कमांड नाम बदलाव: `/alfred:9-help` → `/alfred:9-feedback` + उपयोगकर्ता प्रतिक्रिया वर्कफ़्लो सुधार | 2025-10-28 |
| **v0.8.0**  | 🏷️ @DOC TAG स्वचालित जनरेशन सिस्टम + SessionStart संस्करण जांच सुधार                           | 2025-10-27 |
| **v0.7.0**  | 🌍 पूर्ण भाषा स्थानीयकरण सिस्टम (अंग्रेज़ी, कोरियाई, जापानी, चीनी, स्पेनिश)                      | 2025-10-26 |
| **v0.6.3**  | ⚡ 3-चरण अपडेट वर्कफ़्लो: समानांतर संचालन के माध्यम से 70-80% प्रदर्शन सुधार                     | 2025-10-25 |
| **v0.6.0**  | 🏗️ प्रमुख आर्किटेक्चर रीफैक्टरिंग + SPEC मेटाडेटा संरचना सुधार (7 आवश्यक + 9 वैकल्पिक)        | 2025-10-24 |
...
> 📦 **अभी इंस्टॉल करें**: `uv tool install moai-adk` या `pip install moai-adk`
