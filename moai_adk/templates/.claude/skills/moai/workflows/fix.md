...
Snapshot location: {{PROJECT_DIR}}.moai/cache/fix-snapshots/
...
- Snapshot saved to {{PROJECT_DIR}}.moai/cache/fix-snapshots/ for later resume
...
13. Save snapshot to {{PROJECT_DIR}}.moai/cache/fix-snapshots/
