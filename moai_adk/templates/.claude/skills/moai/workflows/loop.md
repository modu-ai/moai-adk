...
- If session duration exceeds 25 minutes OR iteration time doubling:
  - Save proactive checkpoint to {{PROJECT_DIR}}.moai/cache/ralph-snapshots/memory-pressure.json
...
- Save iteration snapshot to {{PROJECT_DIR}}.moai/cache/ralph-snapshots/
...
Snapshot location: {{PROJECT_DIR}}.moai/cache/ralph-snapshots/
...
Loop state file: {{PROJECT_DIR}}.moai/cache/.moai_loop_state.json
...
- Current state saved to {{PROJECT_DIR}}.moai/cache/ralph-snapshots/
