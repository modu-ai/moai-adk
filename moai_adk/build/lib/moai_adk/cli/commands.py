...
from ..post_install import auto_install_on_first_run
...
def init(project_path: str, template: str, interactive: bool, backup: bool, force: bool, force_copy: bool) -> None:
    ...
    try:
        ...
        if result.success:
            click.echo(f"\n{Fore.GREEN}🎉 MoAI-ADK initialized successfully!{Style.RESET_ALL}")
