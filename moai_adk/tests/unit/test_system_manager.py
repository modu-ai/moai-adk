...
class TestSystemManager:
    ...
    def test_check_nodejs_and_npm_no_node(self, mock_print, mock_check_cmd, system_manager):
    ...
    @patch.object(SystemManager, '_check_command_exists')
    @patch('builtins.print')
    def test_check_nodejs_and_npm_no_npm(self, mock_print, mock_check_cmd, system_manager):
    ...
    @patch('builtins.print')
    def test_check_nodejs_and_npm_success(self, mock_print, mock_validate, mock_check_cmd, system_manager):
    ...
    @patch('builtins.print')
    def test_validate_nodejs_environment_success(self, mock_print, mock_ccusage, mock_run, system_manager):
    ...
    @patch('subprocess.run')
    @patch('builtins.print')
    def test_validate_nodejs_environment_command_failed(self, mock_print, mock_run, system_manager):
    ...
    @patch('subprocess.run')
    @patch('builtins.print')
    def test_validate_nodejs_environment_exception(self, mock_print, mock_run, system_manager):
    ...
    @patch('subprocess.run')
    @patch('builtins.print')
    def test_test_ccusage_availability_success(self, mock_print, mock_run, system_manager):
        """Test successful ccusage availability test."""
        mock_run.return_value = MagicMock(
            returncode=0,
            stdout="ccusage help information"
        )
    ...
    @patch('subprocess.run')
    @patch('builtins.print')
    def test_test_ccusage_availability_ccusage_in_output(self, mock_print, mock_run, system_manager):
        """Test ccusage availability when ccusage appears in output despite non-zero exit."""
        mock_run.return_value = MagicMock(
            returncode=1,
            stdout="Error: ccusage requires parameters"
        )
    ...
    @patch('subprocess.run')
    @patch('builtins.print')
    def test_test_ccusage_availability_failed(self, mock_print, mock_run, system_manager):
    ...
    @patch('subprocess.run')
    @patch('builtins.print')
    def test_test_ccusage_availability_timeout(self, mock_print, mock_run, system_manager):
    ...
    @patch('subprocess.run')
    @patch('builtins.print')
    def test_test_ccusage_availability_exception(self, mock_print, mock_run, system_manager):
    ...
    def test_get_system_info_complete(
        self, mock_pkg_mgrs, mock_check_git, mock_nodejs_info,
        mock_processor, mock_machine, mock_release, mock_system, system_manager
    ):
    ...
    @patch.object(SystemManager, '_check_command_exists')
    @patch('subprocess.run')
    def test_get_nodejs_info_all_available(self, mock_run, mock_check_cmd, system_manager):
    ...
    @patch.object(SystemManager, '_check_command_exists')
    @patch('subprocess.run')
    def test_get_nodejs_info_version_query_failed(self, mock_run, mock_check_cmd, system_manager):
    ...
    def test_get_package_managers_info(self, mock_check_cmd, system_manager):
        ...
        expected_managers = ['pip', 'pip3', 'conda', 'brew', 'apt', 'yum', 'dnf', 'choco', 'winget']
