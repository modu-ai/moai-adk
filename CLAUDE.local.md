...
| 측정 | M1 | M2 (관측 설계 수리 후) |
|---|---|---|
| 3-class 정확도 (한국어 원문 124장) | 39/124 = **31.5%** | 59/124 = **47.6%** |
| 2-class(dead/not-dead) 정확도 | 41/124 = 33.1% | 73/124 = **58.9%** |
| `premise_dead` 호출 정밀도 | 29/110 = **26.4%** | 14/48 = **29.2%** (기저율 25%) |
| 「항상 not-dead」 상수 응답 | **93/124 = 75.0%** | 불변 기준선 — 양쪽 다 모델보다 높다 |
