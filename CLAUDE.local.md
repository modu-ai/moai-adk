...
3. **[SHOULD] Paste-ready resume 단일 세션 처리 discipline**: 사용자 수동 규율 — paste-ready resume은 1 세션에서만 paste. 다른 세션에서는 별도 SPEC 작업 OR read-only 활동 (Explore, manager-quality diagnostic). Memory hash 공유로 인한 paste-ready 동시 consume 회피.
