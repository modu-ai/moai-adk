...
- `internal/template/catalog.yaml` (generated by `gen-catalog-hashes --all`; templates are embedded via `//go:embed all:templates` in `embed.go`, so there is no generated `embedded.go`)
